...
const Projets = () => {
  const items = [
    ...
    { id: 3, title: 'CryptoDashboard', image: '/CryptoDashboard.PNG', description: "CryptoDashboard est une plateforme en ligne pour suivre l'évolution des portefeuilles cryptographiques, offrant une vision complète des investissements.<br><br><br>Technologies utilisées : Next.js, Chart.js, MongoDB, Node.js, CSS", video: '/CryptoDashBoard.mp4' },
